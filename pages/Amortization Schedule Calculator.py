...
if letsgo:
    ...
    col1.metric("Level Payment", f"{round(R, 2)}", f"{round(R/loan,2)}% of Loan", delta_color="inverse")
    col2.metric("Total Interest Paid", f"{round(sum,2)}")
    col3.metric("Total Cost of Loan", f"{round(sum2,2)}", f"{round(sum2/loan-1,2)}% of Loan", delta_color="inverse")
